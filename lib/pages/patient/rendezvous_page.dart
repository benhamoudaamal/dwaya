...
class RendezVousPage extends StatefulWidget {
  ...
  const RendezVousPage({super.key, required this.patientId , required this.patientName , this.readOnly =false,});
...
Future<void> loadPatientName() async {
  ...
  Future<void> showDeleteConfirm(BuildContext context, String id , String date , String time) async {
    if (widget.readOnly) return;
  showDialog(
    context: context,
  ...
  body:
      "Le rendez-vous du $date à $time a été supprimé",
);
...
Future<void> showEditRdvDialog(
  ...
  TextEditingController dateController =
      TextEditingController(text: oldDate);
  TextEditingController noteController =
      TextEditingController(text: oldNote);
